        ...
        <section class="section">
         ...
         <div class="row">
            ...
            <span class="input-group-text" id="basic-addon1">Petugas</span>
              ...
              <select class="custom-select" name= "id_petugas" id="inputGroupSelect01">
                <option selected value="20">cumi</option>
            ...
            <span class="input-group-text" id="basic-addon1">Tanggal Bayar</span>
              ...
              <div class="input-group mb-3">
                ...
                <select class="custom-select" name="id_spp" id="inputGroupSelect01">
